...
. Ansible 플레이북을 사용하여 Astra Control Center를 배포하려면 Ansible이 설치된 Ubuntu/RHEL 시스템이 있어야 합니다. 설명된 절차를 따르십시오 link:../automation/automation_ubuntu_debian_setup.html["여기"] Ubuntu 및 의 경우 link:../automation/automation_rhel_centos_setup.html["여기"] RHEL의 경우
