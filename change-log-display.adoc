...
| 2023/03/29 | 자동화 | 개인/공용 배포 옵션과 수동/자동 배포 옵션을 사용하여 ONTAP 모니터링 및 자동 리사이징용 블로그 "FSx for Monitoring and Auto-Resizing using AWS Lambda Function"이 업데이트되었습니다. 
...
| 2022년 10월 25일 | 하이브리드 클라우드 | FSx ONTAP에 대한 VMware 문서 링크를 NFS 데이터 저장소로 추가했습니다 
