...
MapReduce 관련 성능을 위한 핵심 Hadoop 검증은 TeraGen, TeraSort, TeraValidate 및 DFSIO(읽기 및 쓰기)를 통해 수행됩니다. TeraGen 및 TeraSort 검증 결과는 http://www.netapp.com/us/media/tr-3969.pdf[] E-Series에 대해, 그리고 AFF의 "스토리지 계층화"(xref) 섹션에 나와 있습니다.
