...
| 모범 사례 
 ...
 a| 
* 최적의 스토리지 성능을 위해 파일 시스템 용량을 총 데이터베이스 사용 크기의 1.5배 크기로 프로비저닝합니다.
...
|===
자세한 내용은 공간 및 사이징 요구 사항을 참조하십시오 (https://docs.netapp.com/us-en/snapcenter/install/reference_space_and_sizing_requirements.html)[]
