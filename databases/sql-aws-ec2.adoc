...
+
image::sql-awsec2-image1.png[SQL awsec2 이미지1]

. fsxadmin의 암호를 지정합니다.
+
image::sql-awsec2-image2.png[SQL awsec2 이미지2]

. SVM에 대한 암호를 지정합니다.
+
image::sql-awsec2-image3.png[SQL awsec2 이미지3]
...
....
+
image::sql-awsec2-image4.png[SQL awsec2 이미지4]
...
....
+
image::sql-awsec2-image5.png[SQL awsec2 이미지5]
...
....
+
image::sql-awsec2-image6.png[SQL awsec2 이미지6]
...
+
image::sql-awsec2-image7.png[SQL awsec2 이미지7]
...
....
+
image::sql-awsec2-image10.png[SQL awsec2 이미지10]
...
....
+
image::sql-awsec2-image11.png[SQL awsec2 이미지11]
...
....
+
image::sql-awsec2-image12.png[SQL awsec2 이미지12]
...
image::sql-awsec2-image13.png[SQL awsec2 이미지13]
...
+
image::sql-awsec2-image17.png[SQL awsec2 이미지17]

+
LUN이 이미 용량 할당된 경우 호스트 로그 디렉토리를 나타내는 마운트 지점을 선택할 수 있습니다.

+
image::sql-awsec2-image18.png[SQL awsec2 이미지18]
...
+
image::sql-awsec2-image19.png[SQL awsec2 이미지19]

.. 백업할 데이터베이스를 선택한 다음 * Next * 및 (**)를 선택하여 정책을 만들지 않은 경우 추가합니다. 새 SQL Server 백업 정책 * 에 따라 새 정책을 만듭니다.
+
image::sql-awsec2-image20.png[SQL awsec2 이미지20]
...
+
image::sql-awsec2-image21.png[SQL awsec2 이미지21]

.. 백업을 테스트하려면 * 지금 백업 * 을 클릭합니다. 팝업 창에서 * 백업 * 을 선택합니다.
+
image::sql-awsec2-image22.png[SQL awsec2 이미지22]

.. 백업이 완료되었는지 확인하려면 * Monitor * 를 선택합니다.
+
image::sql-awsec2-image23.png[SQL awsec2 이미지23]
...
+
image::sql-awsec2-image26.png[SQL awsec2 이미지26]

. EC2 및 인스턴스 이름에 새 SQL Server 인스턴스를 제공하여 Clone from Backup 지침에 따라 클론 프로세스를 완료합니다.
. 복제를 완료하려면 Monitor 를 선택합니다.
+
image::sql-awsec2-image27.png[SQL awsec2 이미지27]
