...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=c0df32f8-d6d3-4b79-b0bd-b01200f3a2e8["SnapMirror 및 BlueXP를 통해 사내에서 FSx/EC2로 Oracle 데이터베이스 마이그레이션"^]
