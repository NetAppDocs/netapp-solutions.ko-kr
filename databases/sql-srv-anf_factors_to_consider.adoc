...
image::sql-srv-anf_image1.png[SQL SRV 관리 이미지1]
...
image::sql-srv-anf_image2.png[SQL SRV 관리 이미지2]
...
image::sql-srv-anf_image3.png[SQL SRV 관리 이미지3]
...
image::sql-srv-anf_image4.png[SQL SRV 관리 이미지4]
