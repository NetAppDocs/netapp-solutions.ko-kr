...
[%collapsible]
====
NetApp는 SnapCenter UI 툴을 사용하여 Azure 클라우드에 구축된 Oracle 데이터베이스를 관리하는 것이 좋습니다. 자세한 내용은 TR-4988: link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["SnapCenter를 사용하여 ANF에서 Oracle 데이터베이스 백업, 복구 및 클론 생성"^] 를 참조하십시오.
...
+
link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["SnapCenter를 사용하여 ANF에서 Oracle 데이터베이스 백업, 복구 및 클론 생성"^]
