...
---
= Amazon FSx ONTAP에서 iSCSI를 사용하여 Oracle을 간편하고 자동으로 배포합니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
----
. 최신 버전의 Ansible 및 Git가 설치된 Ansible 컨트롤러 노드로 EC2 Linux 인스턴스를 프로비저닝합니다. 자세한 내용은 다음 링크를 참조하십시오. link:https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["NetApp 솔루션 자동화 시작하기"^] 섹션 -
