...
* link:https://bluexp.netapp.com/blog/aws-fsxn-blg-migrate-vmware-to-amazon-ec2-iscsi-based-fsx-for-ontap["Amazon EC2 및 Amazon FSx for NetApp ONTAP iSCSI 프로토콜을 사용하여 VMware VM을 AWS로 마이그레이션합니다"]
