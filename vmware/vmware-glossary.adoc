...
* link:https://docs.netapp/com/us-en/vontap-apps-dbs/vmware/vmware-vsphere-overview.html["NetApp ONTAP는 모든 스토리지 프로토콜을 지원합니다"]
...
* link:https://docs.netapp.com/us-en/ntap-apps-dbs/vmware/vmware-srm-overview.html["NetApp ONTAP 9가 포함된 VMware 사이트 복구 관리자"]
