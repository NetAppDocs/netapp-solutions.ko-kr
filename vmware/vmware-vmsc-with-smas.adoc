...
* link:https://docs.netapp.com/us-en/netapp-solutions/vmware/vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["호스트당 이중 스토리지 패브릭(HBA 2개 또는 iSCSI용 이중 VLAN)으로 구축된 VMware vSphere 호스트"]..
...
* link:https://docs.netapp.com/us-en/netapp-solutions/vmware/vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["스토리지 VM 및 LIF를 사용할 수 있습니다"]
