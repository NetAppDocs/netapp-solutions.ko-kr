...
* link:../ehc/aws-vmc-veeam-fsx-solution.html["Veeam 백업 및 복구. ONTAP용 FSx로 VMC에서 복원"]
* link:../ehc/aws-dro-overview.html["ONTAP 및 VMC용 FSx를 통한 재해 복구(DRO"]
...
* link:../ehc/gcp-app-dr-sc-cvs-veeam.html["NetApp SnapCenter를 사용한 애플리케이션 정합성 보장 재해 복구 및 NetApp CVS에 Veeam 복제 GCVE"]
