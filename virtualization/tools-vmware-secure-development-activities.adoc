...
| 8143 | REST API용 HTTPS 연결 


| 8043 | HTTPS 연결 


| 9060 | https 연결을 통한 SOAP에 사용되는 HTTPS 연결 클라이언트가 ONTAP 도구 API 서버에 연결할 수 있도록 이 포트를 열어야 합니다. 


| 22 | SSH(기본적으로 비활성화됨) 


| 9080 | HTTPS 연결 - VP 및 SRA - 루프백에서만 내부 연결 


| 9083 | HTTPS 연결 - VP 및 SRA 


|  | https 연결을 통한 SOAP에 사용됩니다 


| 1162 | VP SNMP 트랩 패킷입니다 


| 1527)을 참조하십시오 | Derby 데이터베이스 포트, 이 컴퓨터와 자체 사이에서만, 외부 연결은 허용되지 않음 -- 내부 연결만 
|===
