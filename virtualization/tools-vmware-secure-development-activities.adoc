...
** vCenter 플러그인별 권한 자세한 내용은 을 참조하십시오 https://["이 링크"^].
...
|===
* * CA(인증 기관) 서명 인증서 지원. * VMware vSphere용 ONTAP 툴은 CA 서명 인증서를 지원합니다. 자세한 내용은 다음을 참조하십시오 https://["KB 문서를 참조하십시오"^] 를 참조하십시오.
