...
summary: NetApp용 verify_data_netapp.py 벡터 데이터베이스 솔루션입니다 
---
= 부록 C: verify_data_netapp.py
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
이 섹션에는 NetApp 벡터 데이터베이스 솔루션에서 벡터 데이터베이스의 유효성을 검사하는 데 사용할 수 있는 샘플 Python 스크립트가 포함되어 있습니다.
