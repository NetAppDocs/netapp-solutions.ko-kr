...
| Scikit 학습 | Scikit-Learn은 견적기라고 하는 수십 가지의 기계 학습 알고리즘과 모델을 제공합니다. 각각 https://scikit-learn.org/stable/glossary.html#term-estimators["평가자"^] 를 사용하여 일부 데이터에 장착할 수 있습니다 방법. 
|===
