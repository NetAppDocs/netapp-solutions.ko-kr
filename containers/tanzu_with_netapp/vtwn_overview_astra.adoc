...
. Astra Control Center를 배포하는 Ansible 플레이북을 사용하려면 Ansible이 설치된 Ubuntu/RHEL 시스템이 있어야 합니다. 절차를 따르십시오 https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["여기"] Ubuntu 및 RHEL의 경우
