...
자세한 내용은 Astra Trident 웹 사이트를 참조하십시오 https://netapp-trident.readthedocs.io/en/stable-v21.07/index.html["여기"].
...
| NetApp Astra Control Center를 참조하십시오 | 애플리케이션 인식 데이터 관리 | 21.08.65 


| NetApp Astra Trident | 스토리지 오케스트레이션 | 21.07.1 


| Red Hat OpenShift | 컨테이너 오케스트레이션 | 4.6 EUS, 4.7 
