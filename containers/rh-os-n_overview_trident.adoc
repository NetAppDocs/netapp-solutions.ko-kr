...
Astra Trident의 최신 버전은 2021년 7월 21.07에 출시되었습니다. Kubernetes 배포를 찾을 수 있는 Trident의 버전에 대한 지원 매트릭스입니다 https://netapp-trident.readthedocs.io/en/stable-v21.07/support/requirements.html#supported-frontends-orchestrators["여기"].
...
. 설치 아카이브를 관리 워크스테이션에 다운로드하고 압축을 풉니다. Trident의 현재 버전은 21.07이며 다운로드할 수 있습니다 https://github.com/NetApp/trident/releases/download/v21.07.1/trident-installer-21.07.1.tar.gz["여기"].
+
[listing]
----
...
작업자 노드에서 스토리지 서비스를 실행하도록 구성하려면 다음 단계를 수행하십시오.
