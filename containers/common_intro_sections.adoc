...
NetApp AFF/FAS 플랫폼에 대한 자세한 내용을 보려면 클릭하십시오 https://["여기"].
...
Astra Trident의 최신 버전은 2022년 4월 22.04입니다. Kubernetes 배포를 찾을 수 있는 Trident의 버전에 대한 지원 매트릭스입니다 https://["여기"].
