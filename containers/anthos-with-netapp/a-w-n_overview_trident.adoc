...
NOTE: Helm은 GKE-Admin 워크스테이션에 기본적으로 설치되지 않습니다. Ubuntu에서 작동하는 바이너리 형식으로 에서 다운로드할 수 있습니다 https://helm.sh/docs/intro/install/["Helm 설치 페이지"].
...
link:a-w-n_trident_ontap_nfs.html["다음으로, NetApp ONTAP NFS를 살펴보겠습니다."]
