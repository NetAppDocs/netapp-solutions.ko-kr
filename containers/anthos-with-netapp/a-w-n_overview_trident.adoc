...
Astra Trident의 최신 버전에 대한 문서를 찾을 수 있습니다 https://["여기"]. Kubernetes 배포를 찾을 수 있는 Trident의 버전에 대한 지원 매트릭스입니다 https://["여기"].
...
Astra Trident 설치에 대한 자세한 내용은 을 참조하십시오 https://["여기"].
