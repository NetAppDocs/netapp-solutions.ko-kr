...
이 프로세스에 대해 자세히 알아보려면 언제든지 을(를) 참조하십시오 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=255640f5-4dff-438c-8d50-b01200f017d1["자세한 단계별 안내 비디오를 따릅니다"].

다음은 HCX vMotion 옵션의 스크린샷입니다.

image:anfd-hcx-image20.png["오류: 그래픽 이미지가 없습니다"]

이 프로세스에 대해 자세히 알아보려면 언제든지 을(를) 참조하십시오 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=986bb505-6f3d-4a5a-b016-b01200f03f18["자세한 단계별 안내 비디오를 따릅니다"].
