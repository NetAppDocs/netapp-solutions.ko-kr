...
* 기존 Google Cloud VMware Engine SDDC(소프트웨어 정의 데이터 센터)를 사용하거나 이를 사용하여 프라이빗 클라우드를 생성합니다 https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp/gcp-setup.html["NetApp 링크"^] 또는 이 https://cloud.google.com/vmware-engine/docs/create-private-cloud["Google 링크"^].
