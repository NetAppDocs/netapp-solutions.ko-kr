...
SnapCenter 설정 및 데이터 복제에 대한 단계별 지침은 을 참조하십시오 https://docs.netapp.com/us-en/netapp-solutions/ehc/aws/aws-guest-dr-overview.html#config-snapmirror["SnapCenter를 사용하여 복제를 설정합니다"]

link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=395e33db-0d63-4e48-8898-b01200f006ca["비디오: SnapCenter로 SQL VM 보호"]
...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8b7e4a9b-7de1-4d48-a8e2-b01200f00692["비디오: SQL VM의 Veeam 복제"]

====
.Microsoft SQL Server VM의 페일오버
[%collapsible]
====
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9762dc99-081b-41a2-ac68-b01200f00ac0["비디오: SQL VM의 페일오버"]
