...
+
image::aws-config-1.png[AWS 구성 1]

. AWS 지역, 구축 및 호스트 유형과 SDDC 이름을 구성합니다.
+
image::aws-config-2.png[AWS 구성 2]

. 원하는 AWS 계정에 연결하고 AWS Cloud 포메이션 스택을 실행합니다.
+
image::aws-config-3.png[AWS 구성 3]

+
image::aws-config-4.png[AWS 구성 4]

+
image::aws-config-5.png[AWS 구성 5]

+
image::aws-config-6.png[AWS 구성 6]
...
+
image::aws-config-7.png[AWS 구성 7]
...
+
image::aws-config-8.png[AWS 구성 8]

. SDDC 구성을 검토 및 확인한 다음 SDDC 구축 을 클릭합니다.
+
image::aws-config-9.png[AWS 구성 9]

+
일반적으로 구축 프로세스를 완료하는 데 약 2시간이 소요됩니다.

+
image::aws-config-10.png[AWS 구성 10]

. 완료되면 SDDC를 사용할 수 있습니다.
+
image::aws-config-11.png[AWS 구성 11]
