...
참고: 현재 데이터 저장소로서의 NetApp 스토리지를 AWS/VMC 및 Azure/AVS의 공개 미리 보기와 GCP/GSVE의 프라이빗 미리 보기로 사용할 수 있습니다. 자세한 내용은 다음 링크를 참조하십시오.

FSx ONTAP용 AWS 보도 자료 곧 기본 데이터 저장소로 제공될 예정입니다!

link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure NetApp Files(ANF)를 Azure용 네이티브 데이터 저장소로 사용합니다"]
