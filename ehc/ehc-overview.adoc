...
추가 NFS 데이터 저장소로서 FSx ONTAP용 AWS 보도 자료 출시 예정!

link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure용 보조 NFS 데이터 저장소인 ANF(Azure NetApp Files)입니다"]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/["CVS(Cloud Volumes Service)를 GCP용 보조 NFS 데이터 저장소로 사용합니다"]
...
link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure용 보조 NFS 데이터 저장소로서 Azure NetApp Files(ANF"]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/["CVS(Cloud Volumes Service)를 GCP용 보조 NFS 데이터 저장소로 사용합니다"]
