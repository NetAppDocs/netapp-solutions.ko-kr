...
image::dr-veeam-anf-image1.png[DR Veeam 및 이미지1]
...
+
image::dr-veeam-anf-image2.png[DR Veeam 및 이미지2]
...
+
image::dr-veeam-anf-image6.png[DR Veeam 및 영상6]

. 정기적으로 실행할 복제 작업을 실행할 복제 스케줄을 선택합니다.
+
image::dr-veeam-anf-image7.png[DR Veeam 및 이미지7]
...
+
image::dr-veeam-anf-image8.png[DR Veeam 및 이미지8]



복제 작업이 시작되면 지정된 접미사의 VM이 대상 AVS SDDC 클러스터/호스트에 채워집니다.

image::dr-veeam-anf-image9.png[DR Veeam 및 이미지9]
...
image::dr-veeam-anf-image13.png[DR Veeam 및 이미지13]

image::dr-veeam-anf-image14.png[DR Veeam 및 이미지14]

VM 복제본의 상태가 Ready에서 Failover로 변경되고 VM은 대상 AVS(Azure VMware Solution) SDDC 클러스터/호스트에서 시작됩니다.

image::dr-veeam-anf-image15.png[DR Veeam 및 이미지15]

페일오버가 완료되면 VM의 상태가 "페일오버"로 변경됩니다.

image::dr-veeam-anf-image16.png[DR Veeam 및 이미지16]
...
image::dr-veeam-anf-image17.png[DR Veeam 및 이미지17]

image::dr-veeam-anf-image18.png[DR Veeam 및 이미지18]

image::dr-veeam-anf-image19.png[DR Veeam 및 이미지19]

image::dr-veeam-anf-image20.png[DR Veeam 및 이미지20]
...
image::dr-veeam-anf-image21.png[DR Veeam 및 이미지21]

운영 환경으로 페일백이 성공한 후 VM이 모두 원래 운영 사이트로 복구됩니다.

image::dr-veeam-anf-image22.png[DR Veeam 및 이미지22]
