...
image::dr-cvo-avs-image1.png[DR cvo 영상1]
...
image::dr-cvo-avs-image2.png[DR cvo 영상 2]
...
+
image::dr-cvo-avs-image3.png[DR cvo 영상 3]

. Jetstream DR 인터페이스에서 다음 작업을 완료합니다.
+
.. I/O 필터 패키지를 사용하여 클러스터를 구성합니다.
+
image::dr-cvo-avs-image4.png[DR cvo 영상 4]

.. 복구 사이트에 있는 Azure Blob 저장소를 추가합니다.
+
image::dr-cvo-avs-image5.png[DR cvo 영상 5]
...
+
image::dr-cvo-avs-image6.png[DR cvo 영상 6]

+
image::dr-cvo-avs-image7.png[DR cvo의 평균 영상7]

. 사용 가능한 데이터 저장소 또는 독립 공유 iSCSI 스토리지 풀에서 VMDK를 사용하여 각 DRVA에 대한 복제 로그 볼륨을 생성합니다.
+
image::dr-cvo-avs-image8.png[DR cvo 영상 8]
...
+
image::dr-cvo-avs-image9.png[DR cvo 영상 9]

+
image::dr-cvo-avs-image10.png[DR cvo 영상 10]
...
+
image::dr-cvo-avs-image11.png[DR cvo의 영상 11]

. 복제 로그 볼륨이 고성능 스토리지에 배치되었는지 확인합니다.
+
image::dr-cvo-avs-image12.png[DR cvo의 평균 영상12]

. 작업을 완료한 후 보호 도메인에 대한 보호 시작 을 클릭합니다. 그러면 선택한 VM에 대한 데이터 복제가 지정된 Blob 저장소로 시작됩니다.
+
image::dr-cvo-avs-image13.png[DR cvo의 평균 영상13]

. 복제가 완료되면 VM 보호 상태가 복구 가능으로 표시됩니다.
+
image::dr-cvo-avs-image14.png[DR cvo의 영상14]
...
+
image::dr-cvo-avs-image15.png[DR cvo의 평균 영상 15]
...
+
image::dr-cvo-avs-image16.png[DR cvo의 평균 영상16]
...
+
image::dr-cvo-avs-image17.png[DR cvo의 평균 영상17]

. 정적 IP 주소는 그룹의 개별 VM에 대해 수동으로 구성할 수 있습니다. VM의 NIC View 링크를 클릭하여 IP 주소 설정을 수동으로 구성합니다.
+
image::dr-cvo-avs-image18.png[DR cvo의 평균 영상18]

. 구성 버튼을 클릭하여 해당 VM에 대한 NIC 설정을 저장합니다.
+
image::dr-cvo-avs-image19.png[DR cvo의 평균 이미지19]

+
image::dr-cvo-avs-image20.png[DR cvo의 평균 영상20]
...
+
image::dr-cvo-avs-image25.png[DR cvo 영상 25]
...
+
image::dr-cvo-avs-image26.png[DR cvo의 영상 26]
...
+
image::dr-cvo-avs-image27.png[DR cvo의 평균 영상 27]

+
image::dr-cvo-avs-image28.png[DR cvo의 평균 영상 28]
...
+
image::dr-cvo-avs-image29.png[DR cvo의 평균 영상29]

+
image::dr-cvo-avs-image30.png[DR cvo의 평균 이미지30]

+
강제 대체 작동 에서는 운영 사이트에 더 이상 액세스할 수 없으며 보호 도메인의 소유권이 복구 사이트에 의해 직접 가정되어야 한다고 가정합니다.

+
image::dr-cvo-avs-image31.png[DR cvo의 평균 영상31입니다]

+
image::dr-cvo-avs-image32.png[DR cvo의 평균 영상32입니다]
...
+
image::dr-cvo-avs-image33.png[DR cvo의 평균 영상33입니다]
...
+
image::dr-cvo-avs-image34.png[DR cvo의 평균 영상34]

.. 설정 페이지에서 설정 > 글로벌 설정 > 재해 복구 로 이동합니다.
.. 재해 복구 활성화 를 선택합니다.
.. 적용 을 클릭합니다.
+
image::dr-cvo-avs-image35.png[DR cvo의 평균 영상35입니다]
...
+
image::dr-cvo-avs-image36.png[DR cvo의 평균 영상36입니다]

. Cloud Volumes ONTAP의 LUN을 동일한 드라이브 문자로 복구된 SQL 게스트 VM에 연결합니다.
+
image::dr-cvo-avs-image37.png[DR cvo의 평균 영상37입니다]

. iSCSI 초기자를 열고, 이전에 연결이 끊긴 세션을 지우고, 복제된 Cloud Volumes ONTAP 볼륨에 대한 다중 경로와 함께 새 대상을 추가합니다.
+
image::dr-cvo-avs-image38.png[DR cvo의 평균 영상38]

. DR 이전에 사용한 드라이브 문자와 동일한 드라이브 문자를 사용하여 모든 디스크가 연결되어 있는지 확인합니다.
+
image::dr-cvo-avs-image39.png[DR cvo의 평균 영상39]

. MSSQL 서버 서비스를 다시 시작합니다.
+
image::dr-cvo-avs-image40.png[DR cvo의 평균 영상40입니다]

. SQL 리소스가 다시 온라인 상태인지 확인합니다.
+
image::dr-cvo-avs-image41.png[DR cvo의 평균 영상41]
...
+
image::dr-cvo-avs-image42.png[DR cvo의 평균 이미지 42]
...
+
image::dr-cvo-avs-image43.png[DR cvo의 평균 이미지43]

. 페일백 프로세스를 완료한 다음 VM 보호 및 데이터 정합성 재개를 확인합니다.
+
image::dr-cvo-avs-image44.png[DR cvo의 평균 이미지44]

. VM이 복구된 후 호스트에서 보조 스토리지를 분리하고 운영 스토리지에 접속합니다.
+
image::dr-cvo-avs-image45.png[DR cvo의 평균 영상45]

+
image::dr-cvo-avs-image46.png[DR cvo의 평균 영상46]

. MSSQL 서버 서비스를 다시 시작합니다.
. SQL 리소스가 다시 온라인 상태인지 확인합니다.
+
image::dr-cvo-avs-image47.png[DR cvo의 평균 영상47]
